...
# The geometric mean is the root to the nth power of the products of
...
# Already included in stats.describe().
print('kurtosis:', stats.kurtosis(arr))
# Mode returns two arrays, the first being the actual value(s) that occur the
# most. The second being the number of times they occur.
