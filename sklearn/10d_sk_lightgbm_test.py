# LightGBM is a tree based gradient boosting framework. It boasts faster
# training speed and higher efficiency than xgboost with little to no
# difference in accuracy. One of the defining characteristics of LightGBM is
# that decision trees are split leaf wise instead of level wise. Like other
# tree based algorithms, it does not require feature scaling.
import pandas as pd
